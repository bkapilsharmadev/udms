...
module.exports.createFileVersion = async (fileVersion) => {
    ...
    const query = `INSERT INTO file_versions (file_id, file_name, version_number, document_id, document_uuid, hash, document_url, created_by) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *;`;
