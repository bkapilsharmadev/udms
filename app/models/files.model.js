...
module.exports.createFile = async (file) => {
    const { latest_version_id, document_id, document_uuid, created_by } = file;
    const query = `INSERT INTO files (latest_version_id, document_id, document_uuid, created_by) VALUES ($1, $2, $3, $4) RETURNING *;`;
    const values = [latest_version_id, document_id, document_uuid, created_by];
